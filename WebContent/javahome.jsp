...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Jtechy</a>
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Object Orientation</a></li>
                <li><a href="#">Declarations</a></li>
                <li><a href="#">OO Programming</a></li>                
                <li><a href="#">Assignements & Operators</a></li>
                <li><a href="#">Flow Control</a></li>
                <li><a href="#">Exception Handling</a></li>
                <li><a href="#">Multithreading</a></li>
                <li><a href="#">Strings & I/O</a></li>
                <li><a href="#">Generics & collections</a></li>
              </ul>
            </li>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted">All rights reserved, @Jtechy.co.in</p>
      </div>
    </footer>
